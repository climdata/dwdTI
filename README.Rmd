...
tmb <- subset(tmbCompl, tmbCompl$ts<min(tia30$ts)) 
...
tmb <- subset(tmbCompl, tmbCompl$ts<min(tia10$ts))
...
tmb <- subset(tmbCompl, tmbCompl$ts<min(til10$ts))
...
tmb <- subset(tmbCompl, tmbCompl$ts<min(til30$ts))
...
tmb <- subset(tmbCompl, tmbCompl$ts<min(tis99$ts))
